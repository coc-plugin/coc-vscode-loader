import { ViewColumn, window, Uri } from 'coc.nvim'
import type { Disposable, ExtensionContext, WebviewPanel } from 'coc.nvim'
...
export class WelcomePagePanel {
  ...
  private getWalkthroughs() {
    try {
      const extension = vscode.extensions.getExtensionById("redhat.ansible");
