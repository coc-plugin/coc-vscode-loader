...
Browse the [registry website](https://coc-plugin.github.io/coc-vscode-registry/) or check [registry.json](https://github.com/coc-plugin/coc-vscode-registry/blob/main/registry.json). Currently **112+ plugins**: Volar (Vue), Prisma, HTML CSS Support, Lua, Deno, TOML (Taplo), Ansible, YAML, Tailwind CSS, Biome, Stylelint, Prettier, Svelte, Astro, gitignore, ShellCheck, Rust Analyzer, PHP Intelephense, 94 snippet extensions, and more being added. See [`docs/conversion-feasibility-210.md`](./docs/conversion-feasibility-210.md) for the full 210-plugin analysis.
