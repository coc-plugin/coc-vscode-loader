...
const BUILTIN_REGISTRY: PackageInfo[] = [
  ...
  },
  {
    ...
    type: 'pure-lsp',
    source: { type: 'npm', package: 'vscode-prisma' },
  ...
  },
  {
    ...
    type: 'direct-api',
    source: { type: 'npm', package: 'vscode-html-css' },
  ...
  },
  {
    ...
    type: 'pure-lsp',
    source: { type: 'npm', package: 'vscode-json-languageservice' },
  ...
  },
  {
    ...
    type: 'pure-lsp',
    source: { type: 'npm', package: 'vscode-yaml' },
